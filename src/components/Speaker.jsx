      ...
      <div className="bg-yellow-300 px-4 pb-6 sm:px-6 lg:relative lg:z-10 lg:pb-0">
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-8 lg:gap-8 lg:px-8">
          <div className="relative lg:col-span-3 lg:-my-8">
            ...
            />
            <div className="mx-auto max-w-xl px-4 sm:max-w-3xl sm:px-6 lg:h-full">
          ...
          <div className="my-2 lg:col-span-5 lg:pl-8">
            <div className="mx-auto max-w-xl sm:max-w-3xl lg:max-w-none lg:px-0 lg:py-8 ">
              <blockquote>
                <div>
                  <h1 className="space- font-display text-5xl font-bold tracking-tighter text-black sm:text-6xl md:text-7xl">
                    <br /> {name}
                  </h1>
                </div>
                <div>
                  <h2 className="space- text-md font-display font-bold tracking-tighter text-black sm:text-lg">
                    <br /> {bio}
                  </h2>
                </div>
                <div>
